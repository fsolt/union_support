...
```{generating missing, converting zip to fips, and grabbing IVs}
...
```{this line estimates the model on each of those 10 datasets and combine the results taking into account our uncertainty of the missing values of our data}
